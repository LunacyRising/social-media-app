...
export const MAIL_CONFIRM_SUCCESS = "MAIL_CONFIRM_SUCCESS";
export const MAIL_CONFIRM_FAILED = "MAIL_CONFIRM_FAILED";
...
export const VERIFY_CAPTCHA_FAIL = "VERIFY_CAPTCHA_FAIL";
...
export const CHANGE_AVATAR_SUCESS = "CHANGE_AVATAR_SUCESS";
