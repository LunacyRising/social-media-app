...
export const addImageChat = async (e,args) => {
    ...
    // test
    saveMessage({chatMessage : preview, receiver, sender, avatar, senderId, receiverId})
    sendMessage("chat message", {chatMessage : preview, receiver, sender, avatar, senderId, receiverId}, socket);
  };